     ...
     <div id="contact" class="contact">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="title">
                        <h2>Chat <strong class="black"> Gpt</strong></h2>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid" id="signForm">
                <textarea readonly class="form-control" spellcheck="false" style="height:400px; border:1px solid; overflow:auto;">{{ isset($response['content']) ? ($response['content']) : ""  }}</textarea>
                    <form action="/write/generate" method="post">
                        @csrf
                        <input type="text" required name="title" class="`form-control font-bold" style="width: 90%;padding: 12px;" placeholder="Type your article title..."/>
                        <button class="rounded-md bg-emerald-500 px-4 py-3 font-semibold" style="background-color: #052501;color: white;border-radius: 10px">Generate</button>
                    </form>
        </div>
        <br>
            <br>
