     ...
     <div id="contact" class="contact">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="title">
                        <h2>Forget <strong class="black">Password</strong></h2>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid d-flex" id="signForm">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                ...
                <form class="main_formms" method="POST" action="{{ route('feedback-form-store') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            ...
                            @endif
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <label class="input-lbl">Confirm Password</label>
