     ...
     <div id="contact" class="contact">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="title">
                        <h2>Sign <strong class="black"> IN</strong></h2>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid d-flex" id="signForm">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                <div class="container">
                    ...
                    <form class="main_formms" method="POST" action="{{ route('login') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 mt-4 mb-4">
                                <button class="send">Send</button>
                            </div>
                        </div>
                        <div class="loginclsp" style="">
                            <a href="{{route('sign-up')}}" class="forgetCls" style="color:white;font-size:18px;">Sign Up </a>
                            <a href="{{route('forget-password')}}" class="forgetCls" style="color:white;font-size:18px;">Forget Password ?</a>
                        </div>
                    </form>
